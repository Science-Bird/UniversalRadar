...
namespace UniversalRadar
{
    ...
    public class UniversalRadar : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            CameraClipExtension = base.Config.Bind("!General", "Increased Radar Vertical Render Distance", 0f, new ConfigDescription("Increasing this means more objects/scenery above and below a player will be picked up on the radar screen (set this to 0 for vanilla clipping distance).", new AcceptableValueRange<float>(0f, 150f)));
